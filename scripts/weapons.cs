...
$AccessoryVar[Shiv, $SpecialVar] = $SpecialVarATK @" "@round(8*$GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 0.5";

$AccessoryVar[CrudeAxe, $SpecialVar] = "6 "@round(10 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 0.5";
$AccessoryVar[Hatchet, $SpecialVar] = "6 "@round(20 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 0.8";			//12 (5)
$AccessoryVar[BroadSword, $SpecialVar] = "6 "@round(35 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.2";		//21 (5)
$AccessoryVar[WarAxe, $SpecialVar] = "6 "@round(70 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.8";			//30 (7)
$AccessoryVar[LongSword, $SpecialVar] = "6 "@round(65 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.5";			//39 (5)
$AccessoryVar[BattleAxe, $SpecialVar] = "6 "@round(144 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.8";		//48 (9)
$AccessoryVar[BastardSword, $SpecialVar] = "6 "@round(133 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.5";		//57 (7)
$AccessoryVar[Halberd, $SpecialVar] = "6 "@round(176 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.5";			//66 (8)
$AccessoryVar[Claymore, $SpecialVar] = "6 "@round(188 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.5";			//75.2 (7.5)
$AccessoryVar[KeldriniteLS, $SpecialVar] = "6 "@round(90 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 2";		//90 (0.5)
$AccessoryVar[MeteorAxe, $SpecialVar] = "6 "@round(110 * $GlobalATKMod)@" 13 5 "@ $SpecialVarSTRScaling @" 1.4"; //Mana harvest

//.................................................................................
$AccessoryVar[Club, $SpecialVar] = "6 "@round(12 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 0.5";			//12 (3)
$AccessoryVar[QuarterStaff, $SpecialVar] = "6 "@round(35 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 0.8";		//21 (5)
$AccessoryVar[BoneClub, $SpecialVar] = "6 "@round(34 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1";			//26 (4)
$AccessoryVar[SpikedClub, $SpecialVar] = "6 "@round(30 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.2";		//30 (3)
$AccessoryVar[Mace, $SpecialVar] = "6 "@round(78 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.5";			//39 (6)
$AccessoryVar[HammerPick, $SpecialVar] = "6 "@round(80 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.2";		//48 (5)
$AccessoryVar[SpikedBoneClub, $SpecialVar] = "6 "@round(70 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.5";		//52.5 (4)
$AccessoryVar[LongStaff, $SpecialVar] = "6 "@round(114 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 1.75";		//57 (6)
$AccessoryVar[WarHammer, $SpecialVar] = "6 "@round(176 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 2";		//66 (8)
$AccessoryVar[JusticeStaff, $SpecialVar] = "6 "@round(118 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 2";		//70.8 (5)
$AccessoryVar[WarMaul, $SpecialVar] = "6 "@round(175 * $GlobalATKMod)@" "@ $SpecialVarSTRScaling @" 2";			//75 (7)
//.................................................................................
$AccessoryVar[PickAxe, $SpecialVar] = "6 "@round(16 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 0.5";			//12 (4)
$AccessoryVar[Knife, $SpecialVar] = "6 "@round(18 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 0.8";			//18 (1)
$AccessoryVar[Dagger, $SpecialVar] = "6 "@round(23 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1";			//23 (3)
$AccessoryVar[ShortSword, $SpecialVar] = "6 "@round(50 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.25";		//30 (5)
$AccessoryVar[Spear, $SpecialVar] = "6 "@round(78 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.5";			//39 (6)
$AccessoryVar[Gladius, $SpecialVar] = "6 "@round(80 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.5";			//48 (5)
$AccessoryVar[Trident, $SpecialVar] = "6 "@round(114 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.8";			//57 (6)
$AccessoryVar[Rapier, $SpecialVar] = "6 "@round(110 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.8";			//66 (5)
$AccessoryVar[AwlPike, $SpecialVar] = "6 "@round(200 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 2";			//75 (8)
$AccessoryVar[MeteorDagger, $SpecialVar] = "6 "@round(40 * $GlobalATKMod)@" 12 1 "@ $SpecialVarDEXScaling @" 1.2"; // Mana theif
//.................................................................................
$AccessoryVar[CastingBlade, $SpecialVar] = "6 "@round(18 * $GlobalATKMod)@"";
$AccessoryVar[CastingScepter, $SpecialVar] = "6 "@round(35 * $GlobalATKMod)@"";
//.................................................................................
$AccessoryVar[Sling, $SpecialVar] = "6 "@round(11 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 0.8";			//11 (2)
$AccessoryVar[ShortBow, $SpecialVar] = "6 "@round(23 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.2";			//23 (3)
$AccessoryVar[LightCrossbow, $SpecialVar] = "6 "@round(72 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.2";		//36 (6)
$AccessoryVar[LongBow, $SpecialVar] = "6 "@round(86 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.5";			//51.6 (5)
$AccessoryVar[CompositeBow, $SpecialVar] = "6 "@round(85 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.5";		//63.75 (4)
$AccessoryVar[RepeatingCrossbow, $SpecialVar] = "6 "@round(75 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.5";	//75 (3)
$AccessoryVar[ElvenBow, $SpecialVar] = "6 "@round(89 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.8";			//89 (3)
$AccessoryVar[AeolusWing, $SpecialVar] = "6 "@round(101 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 1.8";		//101 (2)
$AccessoryVar[HeavyCrossbow, $SpecialVar] = "6 "@round(300 * $GlobalATKMod)@" "@ $SpecialVarDEXScaling @" 2";		//112.5 (8)
//.................................................................................
$AccessoryVar[SmallRock, $SpecialVar] = "6 "@round(5 * $GlobalATKMod)@"";
$AccessoryVar[BasicArrow, $SpecialVar] = "6 "@round(12 * $GlobalATKMod)@"";
$AccessoryVar[ShortQuarrel, $SpecialVar] = "6 "@round(14 * $GlobalATKMod)@"";
$AccessoryVar[LightQuarrel, $SpecialVar] = "6 "@round(16 * $GlobalATKMod)@"";
$AccessoryVar[SheafArrow, $SpecialVar] = "6 "@round(30 * $GlobalATKMod)@"";
$AccessoryVar[StoneFeather, $SpecialVar] = "6 "@round(40 * $GlobalATKMod)@"";
$AccessoryVar[BladedArrow, $SpecialVar] = "6 "@round(42 * $GlobalATKMod)@"";
$AccessoryVar[HeavyQuarrel, $SpecialVar] = "6 "@round(44 * $GlobalATKMod)@"";
$AccessoryVar[MetalFeather, $SpecialVar] = "6 "@round(60 * $GlobalATKMod)@"";
$AccessoryVar[Talon, $SpecialVar] = "6 "@round(80 * $GlobalATKMod)@"";
$AccessoryVar[CeraphumsFeather, $SpecialVar] = "6 "@round(105 * $GlobalATKMod)@"";

$AccessoryVar[NoviceStaff, $SpecialVar] = "6 "@round(25 * $GlobalATKMod)@"";
$AccessoryVar[MagesStaff, $SpecialVar] = "6 "@round(50 * $GlobalATKMod)@"";
$AccessoryVar[FireStaff, $SpecialVar] = "6 "@round(75 * $GlobalATKMod)@"";
$AccessoryVar[ThornStaff, $SpecialVar] = "6 "@round(20 * $GlobalATKMod)@"";
$AccessoryVar[HealerStaff, $SpecialVar] = "6 "@round(10 * $GlobalATKMod)@"";
//.................................................................................
...
$AccessoryVar[RHatchet, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[Hatchet, $SpecialVar], 1) * $RustyDamageAmp) @" 22 "@FixDecimals(getWord($AccessoryVar[Hatchet, $SpecialVar],3) * $RustyScalingAmp); //Word::getSubWord($AccessoryVar[Hatchet, $SpecialVar],2,99);
$AccessoryVar[RBroadSword, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[BroadSword, $SpecialVar], 1) * $RustyDamageAmp)@" 22 "@ FixDecimals(getWord($AccessoryVar[BroadSword, $SpecialVar],3) * $RustyScalingAmp);//Word::getSubWord($AccessoryVar[BroadSword, $SpecialVar],2,99);
$AccessoryVar[RLongSword, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[LongSword, $SpecialVar], 1) * $RustyDamageAmp) @" 22 "@ FixDecimals(getWord($AccessoryVar[LongSword, $SpecialVar],3) * $RustyScalingAmp);//Word::getSubWord($AccessoryVar[LongSword, $SpecialVar],2,99);
$AccessoryVar[RClub, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[Club, $SpecialVar], 1) * $RustyDamageAmp) @" 22 "@ FixDecimals(getWord($AccessoryVar[Club, $SpecialVar],3) * $RustyScalingAmp);//Word::getSubWord($AccessoryVar[Club, $SpecialVar],2,99);
$AccessoryVar[RSpikedClub, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[SpikedClub, $SpecialVar], 1) * $RustyDamageAmp) @" 22 "@ FixDecimals(getWord($AccessoryVar[SpikedClub, $SpecialVar],3) * $RustyScalingAmp);//Word::getSubWord($AccessoryVar[SpikedClub, $SpecialVar],2,99);
$AccessoryVar[RKnife, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[Knife, $SpecialVar], 1) * $RustyDamageAmp) @" 23 "@FixDecimals(getWord($AccessoryVar[Knife, $SpecialVar],3) * $RustyScalingAmp);//Word::getSubWord($AccessoryVar[Knife, $SpecialVar],2,99);
$AccessoryVar[RDagger, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[Dagger, $SpecialVar], 1) * $RustyDamageAmp) @" 23 "@ FixDecimals(getWord($AccessoryVar[Dagger, $SpecialVar],3) * $RustyScalingAmp);//Word::getSubWord($AccessoryVar[Dagger, $SpecialVar],2,99);
$AccessoryVar[RShortSword, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[ShortSword, $SpecialVar], 1) * $RustyDamageAmp) @" 23 "@FixDecimals(getWord($AccessoryVar[ShortSword, $SpecialVar],3) * $RustyScalingAmp); //Word::getSubWord($AccessoryVar[ShortSword, $SpecialVar],2,99);
$AccessoryVar[RPickAxe, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[PickAxe, $SpecialVar], 1) * $RustyDamageAmp) @" 23 "@ FixDecimals(getWord($AccessoryVar[PickAxe, $SpecialVar],3) * $RustyScalingAmp);//Word::getSubWord($AccessoryVar[PickAxe, $SpecialVar],2,99);
$AccessoryVar[RShortBow, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[ShortBow, $SpecialVar], 1) * $RustyDamageAmp) @" 23 "@ FixDecimals(getWord($AccessoryVar[ShortBow, $SpecialVar],3) * $RustyScalingAmp);//Word::getSubWord($AccessoryVar[ShortBow, $SpecialVar],2,99);
$AccessoryVar[RLightCrossbow, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[LightCrossbow, $SpecialVar], 1) * $RustyDamageAmp) @" 23 "@ FixDecimals(getWord($AccessoryVar[LightCrossbow, $SpecialVar],3) * $RustyScalingAmp);//Word::getSubWord($AccessoryVar[LightCrossbow, $SpecialVar],2,99);
$AccessoryVar[RWarAxe, $SpecialVar] = "6 " @ round(GetWord($AccessoryVar[WarAxe, $SpecialVar], 1) * $RustyDamageAmp) @" 22 "@ FixDecimals(getWord($AccessoryVar[Waraxe, $SpecialVar],3) * $RustyScalingAmp);//Word::getSubWord($AccessoryVar[WarAxe, $SpecialVar],2,99);
...
$AccessoryVar[ChickenWeapon, $SpecialVar] = "6 "@round(114 * $GlobalATKMod)@"";
