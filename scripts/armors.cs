...
$AccessoryVar[PaddedArmor, $SpecialVar] = "1 2 7 30 4 5";
$AccessoryVar[LeatherArmor, $SpecialVar] = "1 5 7 80 4 7";
$AccessoryVar[StuddedLeather, $SpecialVar] = "1 10 7 130 4 9";
$AccessoryVar[SpikedLeather, $SpecialVar] = "1 10 7 180 4 13";
$AccessoryVar[HideArmor, $SpecialVar] = "1 15 7 230 4 18";
$AccessoryVar[ScaleMail, $SpecialVar] = "1 17 7 280 4 22";
$AccessoryVar[BrigandineArmor, $SpecialVar] = "1 20 7 330 4 28";
$AccessoryVar[ChainMail, $SpecialVar] = "1 20 7 380 4 33";
$AccessoryVar[RingMail, $SpecialVar] = "1 20 7 430 4 38";
$AccessoryVar[BandedMail, $SpecialVar] = "1 25 7 480 4 43";
$AccessoryVar[SplintMail, $SpecialVar] = "1 25 7 530 4 47";
$AccessoryVar[BronzePlateMail, $SpecialVar] = "1 35 7 580 4 53";
$AccessoryVar[PlateMail, $SpecialVar] = "1 40 7 630 4 58";
$AccessoryVar[FieldPlateArmor, $SpecialVar] = "1 45 7 680 4 64";
$AccessoryVar[DragonMail, $SpecialVar] = "1 45 7 730 4 70";
$AccessoryVar[FullPlateArmor, $SpecialVar] = "1 75 7 780 4 75";
$AccessoryVar[KeldrinArmor, $SpecialVar] = "1 90 7 880 3 350 4 110";
